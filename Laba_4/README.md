...
являющиеся произведением двух других функций.
...
восстановить табулированную функцию, а именно количество точек в ней и значения
координат точек.
...
Проверьте работу написанных классов. С помощью метода
